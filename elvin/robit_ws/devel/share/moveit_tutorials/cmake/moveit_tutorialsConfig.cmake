...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/elvin/robit_ws/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/elvin/robit_ws/devel)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/elvin/robit_ws/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elvin/robit_ws/src/moveit_tutorials/${idir}'.  ${_report}")
    endif()
